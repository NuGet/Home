...
The one very clear con of this proposal is that this is a breaking change for the pack operation.
...
- If we apply PrivateAssets=all and IncludeAssets=none to those packages:
